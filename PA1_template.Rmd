...
After a quick computation, it looks like there are about `r nrow(nonvales)` rows missing important details.  Let's set up a second dataset, similar to the first, albeit where our nonvalues have been substituted with the mean steps for that same interval.
